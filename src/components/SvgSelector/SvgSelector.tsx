...
interface SvgSelectorType {
    id?: 'arrow-down' | 'right-arrow' | 'arrow-in-round' | string
    svgColor?: any
    className?: any
}

const SvgSelector: FC<SvgSelectorType> = React.memo(({id, svgColor = '#fff', className}) => {
    switch (id) {
        case 'arrow-down':
            return (
        ...
        case 'arrow-in-round':
            return (
                <svg className={className} width={'30'} height={'30'} viewBox={'0 0 30 30'} fill={'none'}
                    ...
                    <path d={'M14.7803 20.2444L20.3803 14.6444L14.7803 9.04443'} stroke={'white'}
                          strokeLinecap={'round'}
                          strokeLinejoin={'round'}/>
                    <path d={'M9.18018 14.6445H20.3802'} stroke={'white'} strokeLinecap={'round'}
                          strokeLinejoin={'round'}/>
                </svg>
            )
        default:
